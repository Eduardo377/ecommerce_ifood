...
@SpringBootTest
@AutoConfigureMockMvc		// eu preciso fazer com que este script de testes configure uma instância de um "client HTTP" (tipo um PostmanFake)
					        // quem é esse cara? o Objeto MockMVC
